...
namespace FixedMath
{
    ...
    public struct FPVector4 : IEquatable<FPVector4>
    {
        ...
        public FPVector4(Fix64 x, Fix64 y, Fix64 z, Fix64 w)
        {
            this.X = x;
            this.Y = y;
            this.Z = z;
        ...
        /// <param name="w">W component of the vector.</param>
        public FPVector4(FPVector3 xyz, Fix64 w)
        {
            this.X = xyz.X;
            this.Y = xyz.Y;
            this.Z = xyz.Z;
        ...
        public FPVector4(Fix64 x, FPVector3 yzw)
        {
            this.X = x;
            this.Y = yzw.X;
            this.Z = yzw.Y;
        ...
        /// <param name="z">Z component of the vector.</param>
        /// <param name="w">W component of the vector.</param>
        public FPVector4(FPVector2 xy, Fix64 z, Fix64 w)
        {
            this.X = xy.X;
            this.Y = xy.Y;
            this.Z = z;
        ...
        /// <param name="w">W component of the vector.</param>
        public FPVector4(Fix64 x, FPVector2 yz, Fix64 w)
        {
            this.X = x;
            this.Y = yz.X;
            this.Z = yz.Y;
        ...
        public FPVector4(Fix64 x, Fix64 y, FPVector2 zw)
        {
            this.X = x;
            this.Y = y;
            this.Z = zw.X;
        ...
        public static Fix64 Dot(FPVector4 a, FPVector4 b)
        {
        ...
        public static void Dot(ref FPVector4 a, ref FPVector4 b, out Fix64 product)
        {
        ...
        public static void Multiply(ref FPVector4 v, Fix64 scale, out FPVector4 result)
        {
            result.X = v.X * scale;
            result.Y = v.Y * scale;
            result.Z = v.Z * scale;
        ...
        public static void Divide(ref FPVector4 v, Fix64 divisor, out FPVector4 result)
        {
        ...
        public static FPVector4 operator *(FPVector4 v, Fix64 f)
        {
            FPVector4 toReturn;
            toReturn.X = v.X * f;
            toReturn.Y = v.Y * f;
        ...
        /// <param name="f">Amount to scale.</param>
        /// <returns>Scaled vector.</returns>
        public static FPVector4 operator *(Fix64 f, FPVector4 v)
        {
            FPVector4 toReturn;
            toReturn.X = v.X * f;
            toReturn.Y = v.Y * f;
        ...
        public static void DistanceSquared(ref FPVector4 a, ref FPVector4 b, out Fix64 distanceSquared)
        {
            Fix64 x = a.X - b.X;
            Fix64 y = a.Y - b.Y;
            Fix64 z = a.Z - b.Z;
        ...
        public static void Distance(ref FPVector4 a, ref FPVector4 b, out Fix64 distance)
        {
            Fix64 x = a.X - b.X;
            Fix64 y = a.Y - b.Y;
            Fix64 z = a.Z - b.Z;
        ...
        public static Fix64 Distance(FPVector4 a, FPVector4 b)
        {
            Fix64 toReturn;
        ...
        public static FPVector4 Lerp(FPVector4 start, FPVector4 end, Fix64 interpolationAmount)
        {
            FPVector4 toReturn;
        ...
        public static void Lerp(ref FPVector4 start, ref FPVector4 end, Fix64 interpolationAmount, out FPVector4 result)
        {
        ...
        /// <param name="result">Interpolated intermediate state.</param>
        public static void Hermite(ref FPVector4 value1, ref FPVector4 tangent1, ref FPVector4 value2, ref FPVector4 tangent2, Fix64 interpolationAmount, out FPVector4 result)
        {
        ...
        /// <param name="interpolationAmount">Amount of the second point to use.</param>
        /// <returns>Interpolated intermediate state.</returns>
        public static FPVector4 Hermite(FPVector4 value1, FPVector4 tangent1, FPVector4 value2, FPVector4 tangent2, Fix64 interpolationAmount)
        {
            FPVector4 toReturn;
