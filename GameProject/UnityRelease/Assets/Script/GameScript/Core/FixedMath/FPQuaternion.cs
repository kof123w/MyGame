...
namespace FixedMath
{
    ...
    public struct FPQuaternion : IEquatable<FPQuaternion>
    {
        ...
        /// <param name="r">Rotation matrix to create the quaternion from.</param>
        /// <param name="q">Quaternion based on the rotation matrix.</param>
        public static void CreateFromRotationMatrix(ref FPMatrix r, out FPQuaternion q)
        {
        ...
        /// <param name="r">Rotation matrix used to create a new quaternion.</param>
        /// <returns>Quaternion representing the same rotation as the matrix.</returns>
        public static FPQuaternion CreateFromRotationMatrix(FPMatrix r)
        {
            FPQuaternion toReturn;
            CreateFromRotationMatrix(ref r, out toReturn);
            return toReturn;
        ...
        /// </summary>
        /// <param name="fpQuaternion">Quaternion to normalize.</param>
        /// <returns>Normalized quaternion.</returns>
        public static FPQuaternion Normalize(FPQuaternion fpQuaternion)
        {
            FPQuaternion toReturn;
            Normalize(ref fpQuaternion, out toReturn);
            return toReturn;
        }
        ...
        public static FPQuaternion Slerp(FPQuaternion start, FPQuaternion end, Fix64 interpolationAmount)
        {
            FPQuaternion toReturn;
        ...
        /// </summary>
        /// <param name="fpQuaternion">Quaternion to conjugate.</param>
        ...
        public static FPQuaternion Conjugate(FPQuaternion fpQuaternion)
        {
            FPQuaternion toReturn;
            Conjugate(ref fpQuaternion, out toReturn);
            return toReturn;
        }
        ...
        /// </summary>
        /// <param name="fpQuaternion">Quaternion to invert.</param>
        ...
        public static FPQuaternion Inverse(FPQuaternion fpQuaternion)
        {
            FPQuaternion result;
            Inverse(ref fpQuaternion, out result);
            return result;
        ...
        /// <param name="rotation">Rotation to apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void TransformX(Fix64 x, ref FPQuaternion rotation, out FPVector3 result)
        {
            //This operation is an optimized-down version of v' = q * v * q^-1.
            //The expanded form would be to treat v as an 'axis only' quaternion
            //and perform standard quaternion multiplication.  Assuming q is normalized,
        ...
        /// <param name="rotation">Rotation to apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void TransformY(Fix64 y, ref FPQuaternion rotation, out FPVector3 result)
        {
            //This operation is an optimized-down version of v' = q * v * q^-1.
            //The expanded form would be to treat v as an 'axis only' quaternion
            //and perform standard quaternion multiplication.  Assuming q is normalized,
        ...
        /// <param name="rotation">Rotation to apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void TransformZ(Fix64 z, ref FPQuaternion rotation, out FPVector3 result)
        {
            //This operation is an optimized-down version of v' = q * v * q^-1.
            //The expanded form would be to treat v as an 'axis only' quaternion
            //and perform standard quaternion multiplication.  Assuming q is normalized,
        ...
        public static FPQuaternion CreateFromAxisAngle(FPVector3 axis, Fix64 angle)
        {
        ...
        public static void CreateFromAxisAngle(ref FPVector3 axis, Fix64 angle, out FPQuaternion q)
        {
			Fix64 halfAngle = angle * F64.C0p5;
			Fix64 s = Fix64.Sin(halfAngle);
            q.X = axis.X * s;
        ...
        public static FPQuaternion CreateFromYawPitchRoll(Fix64 yaw, Fix64 pitch, Fix64 roll)
        {
            FPQuaternion toReturn;
        ...
        public static void CreateFromYawPitchRoll(Fix64 yaw, Fix64 pitch, Fix64 roll, out FPQuaternion q)
        {
        ...
        public static void GetAxisAngleFromQuaternion(ref FPQuaternion q, out FPVector3 axis, out Fix64 angle)
        {
#if !WINDOWS
            axis = new FPVector3();
#endif
            ...
            {
                FPVector3.Divide(ref axis, Fix64.Sqrt(lengthSquared), out axis);
