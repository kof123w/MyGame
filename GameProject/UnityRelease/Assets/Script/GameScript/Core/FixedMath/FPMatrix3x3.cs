...
namespace FixedMath
{
    ...
    public struct FPMatrix3x3
    {
        ...
        public FPMatrix3x3(Fix64 m11, Fix64 m12, Fix64 m13, Fix64 m21, Fix64 m22, Fix64 m23, Fix64 m31, Fix64 m32, Fix64 m33)
        {
            M11 = m11;
            M12 = m12;
            M13 = m13;
        ...
        {
            get { return new FPMatrix3x3(F64.C1, F64.C0, F64.C0, F64.C0, F64.C1, F64.C0, F64.C0, F64.C0, F64.C1); }
        }
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref FPMatrix a, ref FPMatrix3x3 b, out FPMatrix3x3 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
            Fix64 m13 = a.M13 + b.M13;
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref FPMatrix3x3 a, ref FPMatrix b, out FPMatrix3x3 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
            Fix64 m13 = a.M13 + b.M13;
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref FPMatrix a, ref FPMatrix b, out FPMatrix3x3 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
            Fix64 m13 = a.M13 + b.M13;
        ...
        /// <param name="fpMatrix3X3">Upper 3x3 matrix extracted from the XNA matrix.</param>
        public static void CreateFromMatrix(ref FPMatrix matrix4X4, out FPMatrix3x3 fpMatrix3X3)
        {
            fpMatrix3X3.M11 = matrix4X4.M11;
            fpMatrix3X3.M12 = matrix4X4.M12;
            fpMatrix3X3.M13 = matrix4X4.M13;

            fpMatrix3X3.M21 = matrix4X4.M21;
            fpMatrix3X3.M22 = matrix4X4.M22;
            fpMatrix3X3.M23 = matrix4X4.M23;

            fpMatrix3X3.M31 = matrix4X4.M31;
            fpMatrix3X3.M32 = matrix4X4.M32;
            fpMatrix3X3.M33 = matrix4X4.M33;
        }
        /// <summary>
        /// Creates a 3x3 matrix from an XNA 4x4 matrix.
        /// </summary>
        ...
        public static FPMatrix3x3 CreateFromMatrix(FPMatrix matrix4X4)
        {
        ...
        public static void CreateScale(Fix64 scale, out FPMatrix3x3 matrix)
        {
        ...
        public static FPMatrix3x3 CreateScale(Fix64 scale)
        {
        ...
        /// <param name="matrix">Scaling matrix.</param>
        public static void CreateScale(Fix64 x, Fix64 y, Fix64 z, out FPMatrix3x3 matrix)
        {
        ...
        /// <param name="z">Scaling along the z axis.</param>
        /// <returns>Scaling matrix.</returns>
        public static FPMatrix3x3 CreateScale(Fix64 x, Fix64 y, Fix64 z)
        {
        ...
        /// <returns>Product of the multiplication.</returns>
        public static FPMatrix3x3 operator *(FPMatrix3x3 m, Fix64 f)
        {
            FPMatrix3x3 result;
        ...
        /// <param name="f">Scaling value to apply to all components of the matrix.</param>
        /// <returns>Product of the multiplication.</returns>
        public static FPMatrix3x3 operator *(Fix64 f, FPMatrix3x3 m)
        {
            FPMatrix3x3 result;
            Multiply(ref m, f, out result);
            return result;
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref FPMatrix3x3 a, ref FPMatrix b, out FPMatrix3x3 result)
        {
            Fix64 resultM11 = a.M11 * b.M11 + a.M12 * b.M21 + a.M13 * b.M31;
            Fix64 resultM12 = a.M11 * b.M12 + a.M12 * b.M22 + a.M13 * b.M32;
            Fix64 resultM13 = a.M11 * b.M13 + a.M12 * b.M23 + a.M13 * b.M33;
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref FPMatrix a, ref FPMatrix3x3 b, out FPMatrix3x3 result)
        {
            Fix64 resultM11 = a.M11 * b.M11 + a.M12 * b.M21 + a.M13 * b.M31;
            Fix64 resultM12 = a.M11 * b.M12 + a.M12 * b.M22 + a.M13 * b.M32;
            Fix64 resultM13 = a.M11 * b.M13 + a.M12 * b.M23 + a.M13 * b.M33;
        ...
        public static void Multiply(ref FPMatrix3x3 matrix, Fix64 scale, out FPMatrix3x3 result)
        {
        ...
        public static void ToMatrix4X4(ref FPMatrix3x3 a, out FPMatrix b)
        {
#if !WINDOWS
            b = new FPMatrix();
#endif
        ...
        public static FPMatrix ToMatrix4X4(FPMatrix3x3 a)
        {
#if !WINDOWS
            FPMatrix b = new FPMatrix();
#else
            Matrix b;
#endif
            b.M11 = a.M11;
        ...
        /// Computes the transposed matrix of a matrix.
        /// </summary>
        /// <param name="fpMatrix">Matrix to transpose.</param>
        /// <param name="result">Transposed matrix.</param>
        public static void Transpose(ref FPMatrix fpMatrix, out FPMatrix3x3 result)
        {
            Fix64 m21 = fpMatrix.M12;
            Fix64 m31 = fpMatrix.M13;
            Fix64 m12 = fpMatrix.M21;
            Fix64 m32 = fpMatrix.M23;
            Fix64 m13 = fpMatrix.M31;
            Fix64 m23 = fpMatrix.M32;

            result.M11 = fpMatrix.M11;
            result.M12 = m12;
            result.M13 = m13;
            result.M21 = m21;
            result.M22 = fpMatrix.M22;
            result.M23 = m23;
            result.M31 = m31;
            result.M32 = m32;
            result.M33 = fpMatrix.M33;
        }
        ...
        /// </summary>
        /// <param name="fpQuaternion">Quaternion to use to create a matrix.</param>
        /// <param name="result">Matrix representing the quaternion's orientation.</param>
        public static void CreateFromQuaternion(ref FPQuaternion fpQuaternion, out FPMatrix3x3 result)
        {
        ...
        public static FPMatrix3x3 CreateFromQuaternion(FPQuaternion fpQuaternion)
        {
            FPMatrix3x3 result;
            CreateFromQuaternion(ref fpQuaternion, out result);
            return result;
        }
        ...
        public static FPMatrix3x3 CreateFromAxisAngle(FPVector3 axis, Fix64 angle)
        {
            FPMatrix3x3 toReturn;
        ...
        public static void CreateFromAxisAngle(ref FPVector3 axis, Fix64 angle, out FPMatrix3x3 result)
        {
