...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public class MobileMeshInstancedMeshPairHandler : MobileMeshMeshPairHandler
    {
        ...
        protected override TriangleCollidable GetOpposingCollidable(int index)
        {
            ...
            FPMatrix3x3.Transform(ref shape.vA, ref mesh.worldTransform.LinearTransform, out shape.vA);
            FPMatrix3x3.Transform(ref shape.vB, ref mesh.worldTransform.LinearTransform, out shape.vB);
            FPMatrix3x3.Transform(ref shape.vC, ref mesh.worldTransform.LinearTransform, out shape.vC);
            FPVector3 center;
