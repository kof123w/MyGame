        ...
        public override void UpdateTimeOfImpact(Collidable requester, Fix64 dt)
        {
                ...
                )
            {
                ...
                if (minimumRadius * minimumRadius < velocitySquared)
                {
                    ...
                    FPMatrix3x3.CreateFromQuaternion(ref mobileMesh.worldTransform.Orientation, out orientation);
                    ...
                    for (int i = 0; i < MeshManifold.overlappedTriangles.Count; i++)
                    {
                        ...
                        FPMatrix3x3.Transform(ref triangle.vA, ref orientation, out triangle.vA);
                        FPMatrix3x3.Transform(ref triangle.vB, ref orientation, out triangle.vB);
                        FPMatrix3x3.Transform(ref triangle.vC, ref orientation, out triangle.vC);
                        ...
                        FPRayHit fpRayHit;
                        if (GJKToolbox.CCDSphereCast(new FPRay(Toolbox.ZeroVector, velocity), minimumRadius, triangle, ref Toolbox.RigidIdentity, timeOfImpact, out fpRayHit) &&
                            fpRayHit.T > Toolbox.BigEpsilon)
                        {
                            ...
                            if (sidedness != TriangleSidedness.DoubleSided)
                            {
                                ...
                                Fix64 dot;
                                FPVector3.Dot(ref normal, ref fpRayHit.Normal, out dot);
