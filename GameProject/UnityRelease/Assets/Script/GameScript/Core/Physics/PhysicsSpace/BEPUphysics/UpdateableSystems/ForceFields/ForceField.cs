...
namespace BEPUphysics.UpdateableSystems.ForceFields
{
    ...
    public abstract class ForceField : Updateable, IDuringForcesUpdateable
    {
        ...
        protected abstract void CalculateImpulse(Entity e, Fix64 dt, out FPVector3 impulse);
        ...
        /// </summary>
        /// <param name="oldBepUphysicsSpace">Space from which the object has been removed.</param>
