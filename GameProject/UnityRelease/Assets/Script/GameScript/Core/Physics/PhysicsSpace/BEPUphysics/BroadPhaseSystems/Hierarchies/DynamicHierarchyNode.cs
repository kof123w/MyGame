...
namespace BEPUphysics.BroadPhaseSystems.Hierarchies
{
    internal abstract class Node
    {
        ...
        internal abstract void GetOverlaps(ref FPRay fpRay, Fix64 maximumLength, IList<BroadPhaseEntry> outputOverlappedElements);
    ...
    internal sealed class InternalNode : Node
    {
        ...
        internal override void GetOverlaps(ref FPRay fpRay, Fix64 maximumLength, IList<BroadPhaseEntry> outputOverlappedElements)
        {
            Fix64 result;
