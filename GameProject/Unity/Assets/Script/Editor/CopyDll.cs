...
{  
    ...
    public static void MergeSprite()
    {
        ...
        containDll.Add("Framework.Common.dll");
        containDll.Add("Framework.Common.pdb");
        containDll.Add("Framework.Model.dll");
        containDll.Add("Framework.Model.pdb");
        containDll.Add("Framework.View.dll");
        containDll.Add("Framework.View.pdb");
