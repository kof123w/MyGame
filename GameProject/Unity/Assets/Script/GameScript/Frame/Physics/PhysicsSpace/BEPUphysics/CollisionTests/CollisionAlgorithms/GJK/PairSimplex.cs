        ...
        public PairSimplex(ref CachedSimplex cachedSimplex, ref RigidTransform localTransformB)
        {
            ...
            switch (State)
            {
                ...
                case SimplexState.Segment:
                    FPMatrix3x3 transform;
                    FPMatrix3x3.CreateFromQuaternion(ref localTransformB.Orientation, out transform);
                    FPMatrix3x3.Transform(ref cachedSimplex.LocalSimplexB.A, ref transform, out SimplexB.A);
                    FPMatrix3x3.Transform(ref cachedSimplex.LocalSimplexB.B, ref transform, out SimplexB.B);
                    FPVector3.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                ...
                case SimplexState.Triangle:
                    ...
                    FPMatrix3x3.Transform(ref cachedSimplex.LocalSimplexB.A, ref transform, out SimplexB.A);
                    FPMatrix3x3.Transform(ref cachedSimplex.LocalSimplexB.B, ref transform, out SimplexB.B);
                    FPMatrix3x3.Transform(ref cachedSimplex.LocalSimplexB.C, ref transform, out SimplexB.C);
                    FPVector3.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    FPVector3.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);
                ...
                case SimplexState.Tetrahedron:
                    ...
                    FPMatrix3x3.Transform(ref cachedSimplex.LocalSimplexB.B, ref transform, out SimplexB.B);
                    FPMatrix3x3.Transform(ref cachedSimplex.LocalSimplexB.C, ref transform, out SimplexB.C);
                    FPMatrix3x3.Transform(ref cachedSimplex.LocalSimplexB.D, ref transform, out SimplexB.D);
                    FPVector3.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    FPVector3.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);
                    FPVector3.Add(ref SimplexB.C, ref LocalTransformB.Position, out SimplexB.C);
        ...
        public void UpdateCachedSimplex(ref CachedSimplex simplex)
        {
            ...
            switch (State)
            {
                ...
                case SimplexState.Segment:
                    ...
                    FPMatrix3x3 transform;
                    FPMatrix3x3.CreateFromQuaternion(ref LocalTransformB.Orientation, out transform);
                    FPMatrix3x3.TransformTranspose(ref simplex.LocalSimplexB.A, ref transform, out simplex.LocalSimplexB.A);
                    FPMatrix3x3.TransformTranspose(ref simplex.LocalSimplexB.B, ref transform, out simplex.LocalSimplexB.B);
                    break;
                case SimplexState.Triangle:
                    FPVector3.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    FPVector3.Subtract(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                    ...
                    FPMatrix3x3.TransformTranspose(ref simplex.LocalSimplexB.A, ref transform, out simplex.LocalSimplexB.A);
                    FPMatrix3x3.TransformTranspose(ref simplex.LocalSimplexB.B, ref transform, out simplex.LocalSimplexB.B);
                    FPMatrix3x3.TransformTranspose(ref simplex.LocalSimplexB.C, ref transform, out simplex.LocalSimplexB.C);
                    break;
                case SimplexState.Tetrahedron:
                    FPVector3.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    FPVector3.Subtract(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                    ...
                    FPMatrix3x3.TransformTranspose(ref simplex.LocalSimplexB.B, ref transform, out simplex.LocalSimplexB.B);
                    FPMatrix3x3.TransformTranspose(ref simplex.LocalSimplexB.C, ref transform, out simplex.LocalSimplexB.C);
                    FPMatrix3x3.TransformTranspose(ref simplex.LocalSimplexB.D, ref transform, out simplex.LocalSimplexB.D);
                    break;
            }
            simplex.State = State;
        }
