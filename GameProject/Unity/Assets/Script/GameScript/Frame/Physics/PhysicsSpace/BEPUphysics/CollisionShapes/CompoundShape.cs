...
namespace BEPUphysics.CollisionShapes
{
    ...
    public struct CompoundShapeEntry
    {
        ...
        public CompoundShapeEntry(EntityShape shape, FPVector3 position, Fix64 weight)
        {
            position.Validate();
        ...
        ///<param name="weight">Weight of the entry.  This defines how much the entry contributes to its owner
        /// for the purposes of center of rotation computation.</param>
        public CompoundShapeEntry(EntityShape shape, FPQuaternion orientation, Fix64 weight)
        {
    ...
    public class CompoundShape : EntityShape
    {
        ...
        public static void ComputeVolumeDistribution(IList<CompoundShapeEntry> entries, out Fix64 volume, out FPMatrix3x3 volumeDistribution, out FPVector3 center)
        {
            ...
            volumeDistribution = new FPMatrix3x3();
            for (int i = 0; i < entries.Count; i++)
            {
                ...
                FPMatrix3x3.Add(ref volumeDistribution, ref contribution, out volumeDistribution);
            }
            FPMatrix3x3.Multiply(ref volumeDistribution, totalWeightInverse, out volumeDistribution);
        ...
        public static void TransformContribution(ref RigidTransform transform, ref FPVector3 center, ref FPMatrix3x3 baseContribution, Fix64 weight, out FPMatrix3x3 contribution)
        {
            FPMatrix3x3 rotation;
            FPMatrix3x3.CreateFromQuaternion(ref transform.Orientation, out rotation);
            FPMatrix3x3 temp;
            
            //Do angular transformed contribution first...
            FPMatrix3x3.MultiplyTransposed(ref rotation, ref baseContribution, out temp);
            FPMatrix3x3.Multiply(ref temp, ref rotation, out temp);
            ...
            FPMatrix3x3 innerProduct;
            FPMatrix3x3.CreateScale(offset.LengthSquared(), out innerProduct);
            FPMatrix3x3 outerProduct;
            FPMatrix3x3.CreateOuterProduct(ref offset, ref offset, out outerProduct);

            FPMatrix3x3.Subtract(ref innerProduct, ref outerProduct, out temp);

            FPMatrix3x3.Add(ref contribution, ref temp, out contribution);
            FPMatrix3x3.Multiply(ref contribution, weight, out contribution);
