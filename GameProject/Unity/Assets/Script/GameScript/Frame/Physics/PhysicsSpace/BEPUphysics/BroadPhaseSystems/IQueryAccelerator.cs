...
namespace BEPUphysics.BroadPhaseSystems
{
    ...
    public interface IQueryAccelerator
    {
        ...
        bool RayCast(FPRay fpRay, IList<BroadPhaseEntry> outputIntersections);
        ///<summary>
        /// Gets the broad phase entries overlapping the ray.
        ///</summary>
        ///<param name="fpRay">Ray to test.</param>
        ...
        ///<param name="outputIntersections">Overlapped entries.</param>
        ///<returns>Whether or not the ray hit anything.</returns>
        bool RayCast(FPRay fpRay, Fix64 maximumLength, IList<BroadPhaseEntry> outputIntersections);
