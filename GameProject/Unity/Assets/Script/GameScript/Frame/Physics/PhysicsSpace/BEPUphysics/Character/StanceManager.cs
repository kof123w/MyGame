...
namespace BEPUphysics.Character
{
    ...
    public class StanceManager
    {
        ...
        public bool CheckTransition(Stance targetStance, out Fix64 newHeight, out FPVector3 newPosition)
        {
        ...
        CharacterContactPositionState TrySupportLocation(ConvexCollidable<CylinderShape> queryObject, ref FPVector3 position, out Fix64 hintOffset,
