...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class TransformableShape : ConvexShape
    {
        ...
        protected FPMatrix3x3 transform;
        ///<summary>
        ...
        public TransformableShape(ConvexShape shape, FPMatrix3x3 transform)
        {
            this.shape = shape;
        ...
        public TransformableShape(ConvexShape shape, FPMatrix3x3 transform, ConvexShapeDescription description)
        {
            this.shape = shape;
            this.transform = transform;
        ...
        {
            FPVector3 d;
            FPMatrix3x3.TransformTranspose(ref direction, ref transform, out d);
            shape.GetLocalExtremePoint(d, out extremePoint);
            FPMatrix3x3.Transform(ref extremePoint, ref transform, out extremePoint);
        }
