...
namespace MyGame
{
    public class PlayerCharacter : BasePerformer
    {
        ...
        private FPVector3 tangentDirection;
        private FPVector3 contactPosition;
        ...
        public override void Start()
        {
            ...
            drawRay = trans.gameObject.AddComponent<DrawRay>();
        ...
        private void OnContactCreated(EntityCollidable sender, Collidable other, CollidablePairHandler pair, ContactData contact)
        {
            ...
            drawRay.SetData(MathConvertor.FpVector3ConvertToVector3(ref contactPosition),-MathConvertor.FpVector3ConvertToVector3(ref contactNormal));
        }
