...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class BoxShape : ConvexShape
    {
        ...
        public override void GetBoundingBox(ref RigidTransform shapeTransform, out BoundingBox boundingBox)
        {
            ...
            var right = new FPVector3(Fix64.Sign(o.M11) * halfWidth, Fix64.Sign(o.M21) * halfHeight, Fix64.Sign(o.M31) * halfLength);

            var up = new FPVector3(Fix64.Sign(o.M12) * halfWidth, Fix64.Sign(o.M22) * halfHeight, Fix64.Sign(o.M32) * halfLength);

            var backward = new FPVector3(Fix64.Sign(o.M13) * halfWidth, Fix64.Sign(o.M23) * halfHeight, Fix64.Sign(o.M33) * halfLength);
        ...
        /// </summary>
        /// <param name="fpRay">Ray to test against the box.</param>
        ...
        public override bool RayTest(ref FPRay fpRay, ref RigidTransform transform, Fix64 maximumLength, out FPRayHit hit)
        {
            ...
            FPVector3.Subtract(ref fpRay.origin, ref transform.Position, out localOrigin);
            FPQuaternion.Transform(ref localOrigin, ref conjugate, out localOrigin);
            FPVector3 localDirection;
            FPQuaternion.Transform(ref fpRay.direction, ref conjugate, out localDirection);
            ...
            if (tmin > tmax)
                return false;
            hit.T = tmin;
            FPVector3.Multiply(ref fpRay.direction, tmin, out hit.Location);
