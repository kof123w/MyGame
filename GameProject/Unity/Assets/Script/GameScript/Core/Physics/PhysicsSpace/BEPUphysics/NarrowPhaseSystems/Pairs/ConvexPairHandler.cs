        ...
        public override void UpdateTimeOfImpact(Collidable requester, Fix64 dt)
        {
                ...
                )
            {
                ...
                if (minimumRadiusA * minimumRadiusA < velocitySquared)
                {
                    ...
                    FPRayHit fpRayHit;
                    if (GJKToolbox.CCDSphereCast(new FPRay(collidableA.worldTransform.Position, -velocity), minimumRadiusA, collidableB.Shape, ref collidableB.worldTransform, timeOfImpact, out fpRayHit))
                ...
                if (minimumRadiusB * minimumRadiusB < velocitySquared)
                {
                    ...
                    FPRayHit fpRayHit;
                    if (GJKToolbox.CCDSphereCast(new FPRay(collidableB.worldTransform.Position, velocity), minimumRadiusB, collidableA.Shape, ref collidableA.worldTransform, timeOfImpact, out fpRayHit))
                        timeOfImpact = fpRayHit.T;
                }
