...
namespace BEPUik
{
    ...
    public class Bone
    {
        ...
        public Bone(FPVector3 position, FPQuaternion orientation, Fix64 radius, Fix64 height, Fix64 mass)
        ...
        /// <param name="radius">Radius of the bone.</param>
        /// <param name="height">Height of the bone.</param>
        public Bone(FPVector3 position, FPQuaternion orientation, Fix64 radius, Fix64 height)
        {
            Mass = F64.C1;
            Position = position;
        ...
        {
            var localInertiaTensor = new FPMatrix3x3();
            ...
            FPMatrix3x3.Invert(ref localInertiaTensor, out localInertiaTensorInverse);
        }
        ...
        internal void UpdateInertiaTensor()
        {
            ...
            FPMatrix3x3 orientationMatrix;
            FPMatrix3x3.CreateFromQuaternion(ref Orientation, out orientationMatrix);
            FPMatrix3x3.MultiplyTransposed(ref orientationMatrix, ref localInertiaTensorInverse, out inertiaTensorInverse);
            FPMatrix3x3.Multiply(ref inertiaTensorInverse, ref orientationMatrix, out inertiaTensorInverse);
        }
        ...
        {
            FPVector3 velocityChange;
            FPMatrix3x3.Transform(ref impulse, ref inertiaTensorInverse, out velocityChange);
