...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public abstract class ConvexShape : EntityShape
    {
        ...
        public void GetExtremePoint(FPVector3 direction, ref RigidTransform shapeTransform, out FPVector3 extremePoint)
        {
            ...
            {
                FPVector3.Multiply(ref direction, collisionMargin / Fix64.Sqrt(directionLength), out direction);
        ...
        public virtual bool RayTest(ref FPRay fpRay, ref RigidTransform transform, Fix64 maximumLength, out FPRayHit hit)
        {
            return MPRToolbox.RayCast(fpRay, maximumLength, this, ref transform, out hit);
        }
        ...
        public void GetSweptBoundingBox(ref RigidTransform transform, ref FPVector3 sweep, out BoundingBox boundingBox)
        {
