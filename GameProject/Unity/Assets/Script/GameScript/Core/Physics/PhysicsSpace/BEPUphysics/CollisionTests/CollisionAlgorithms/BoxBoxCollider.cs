...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class BoxBoxCollider
    {
        ...
        public static bool AreBoxesColliding(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB)
        {
            ...
            FPMatrix3x3 aO;
            FPMatrix3x3.CreateFromQuaternion(ref transformA.Orientation, out aO);
            FPMatrix3x3 bO;
            FPMatrix3x3.CreateFromQuaternion(ref transformB.Orientation, out bO);
        ...
        /// <param name="transformB">Transform to apply to shape B.</param>
        /// <returns>Whether or not the boxes collide.</returns>
        public static bool AreBoxesColliding(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB, out Fix64 separationDistance, out FPVector3 separatingAxis)
        {
            Fix64 aX = a.HalfWidth;
            Fix64 aY = a.HalfHeight;
            Fix64 aZ = a.HalfLength;
        ...
        /// <param name="transformB">Transform to apply to shape B.</param>
        /// <returns>Whether or not the boxes collide.</returns>
        public static bool AreBoxesCollidingWithPenetration(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB, out Fix64 distance, out FPVector3 axis)
        {
            Fix64 aX = a.HalfWidth;
            Fix64 aY = a.HalfHeight;
            Fix64 aZ = a.HalfLength;
        ...
        /// <param name="transformB">Transform to apply to shape B.</param>
        /// <returns>Whether or not the boxes collide.</returns>
        public static unsafe bool AreBoxesColliding(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB, out Fix64 distance, out FPVector3 axis, out TinyStructList<BoxContactData> contactData)
        {
        ...
        /// <returns>Whether or not the boxes collide.</returns>
#if ALLOWUNSAFE
        public static bool AreBoxesColliding(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB, out Fix64 distance, out FPVector3 axis, out BoxContactDataCache contactData)
#else
...
#if ALLOWUNSAFE
        internal static void GetEdgeEdgeContact(BoxShape a, BoxShape b, ref FPVector3 positionA, ref FPMatrix3x3 orientationA, ref FPVector3 positionB, ref FPMatrix3x3 orientationB, Fix64 depth, ref FPVector3 mtd, out BoxContactDataCache contactData)
#else
...
#endif
        {
            ...
            FPMatrix3x3.TransformTranspose(ref negatedMtd, ref orientationA, out mtdA);
            FPMatrix3x3.TransformTranspose(ref mtd, ref orientationB, out mtdB);
            ...
            FPMatrix3x3.Transform(ref edgeAStart1, ref orientationA, out edgeAStart1);
            FPMatrix3x3.Transform(ref edgeAEnd1, ref orientationA, out edgeAEnd1);
            FPMatrix3x3.Transform(ref edgeBStart1, ref orientationB, out edgeBStart1);
            FPMatrix3x3.Transform(ref edgeBEnd1, ref orientationB, out edgeBEnd1);

            FPMatrix3x3.Transform(ref edgeAStart2, ref orientationA, out edgeAStart2);
            FPMatrix3x3.Transform(ref edgeAEnd2, ref orientationA, out edgeAEnd2);
            FPMatrix3x3.Transform(ref edgeBStart2, ref orientationB, out edgeBStart2);
            FPMatrix3x3.Transform(ref edgeBEnd2, ref orientationB, out edgeBEnd2);
        ...
        private static void GetEdgeData(int index, int axis, Fix64 x, Fix64 y, Fix64 z, out FPVector3 edgeStart, out FPVector3 edgeEnd, out int edgeStartId, out int edgeEndId)
        {
...
#if ALLOWUNSAFE
        internal static void GetFaceContacts(BoxShape a, BoxShape b, ref FPVector3 positionA, ref FPMatrix3x3 orientationA, ref FPVector3 positionB, ref FPMatrix3x3 orientationB, bool aIsFaceOwner, ref FPVector3 mtd, out BoxContactDataCache contactData)
#else
...
#if ALLOWUNSAFE
        private static unsafe void PruneContactsMaxDistance(ref FPVector3 mtd, BoxContactDataCache input, out BoxContactDataCache output)
        {
            ...
            {
                Fix64 distance;
                FPVector3.DistanceSquared(ref data[deepestIndex].Position, ref data[i].Position, out distance);
            ...
            FPVector3 xAxis;
            FPVector3.Subtract(ref data[furthestIndex].Position, ref data[deepestIndex].Position, out xAxis);
            ...
            FPVector3.Dot(ref data[0].Position, ref yAxis, out minY);
            maxY = minY;
            for (int i = 1; i < count; i++)
            {
                Fix64 dot;
                FPVector3.Dot(ref yAxis, ref data[i].Position, out dot);
                if (dot < minY)
                {
                    minY = dot;
                    minYindex = i;
...
#if ALLOWUNSAFE
        private static unsafe void ClipFacesDirect(ref BoxFace clipFace, ref BoxFace face, ref FPVector3 mtd, out BoxContactDataCache outputData)
        {
        ...
        #region Face Vertices
            ...
            for (int i = 0; i < tempData.Count; i++)
            {
                FPVector3.Dot(ref temp[i].Position, ref mtd, out faceDot);
        ...
        private static void GetNearestFace(ref FPVector3 position, ref FPMatrix3x3 orientation, ref FPVector3 mtd, Fix64 halfWidth, Fix64 halfHeight, Fix64 halfLength, out BoxFace boxFace)
        {
            boxFace = new BoxFace();
            ...
            FPMatrix3x3.ToMatrix4X4(ref orientation, out worldTransform);
            ...
            if (absX > absY && absX > absZ)
            {
                ...
                FPMatrix.Transform(ref candidate, ref worldTransform, out candidate);
