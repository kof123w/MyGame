...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public static class InertiaHelper
    {
        ...
        public static void ComputeShapeDistribution(IList<FPVector3> vertices, IList<int> triangleIndices, out Fix64 volume, out FPMatrix3x3 volumeDistribution)
        {
            ...
            bo *= offFactor;
            co *= offFactor;
            volumeDistribution = new FPMatrix3x3(a, bo, co,
                                               bo, b, ao,
                                               co, ao, c);
        ...
        /// <param name="volume">Volume of the shape.</param>
        /// <param name="volumeDistribution">Distribution of the volume as measured from the computed center.</param>
        public static void ComputeShapeDistribution(IList<FPVector3> vertices, IList<int> triangleIndices, out FPVector3 center, out Fix64 volume, out FPMatrix3x3 volumeDistribution)
        {
            //Explanation for the tetrahedral integration bits: Explicit Exact Formulas for the 3-D Tetrahedron Inertia Tensor in Terms of its Vertex Coordinates
            //http://www.scipub.org/fulltext/jms2/jms2118-11.pdf
            //x1, x2, x3, x4 are origin, triangle1, triangle2, triangle3
            ...
            else
            {
                ...
                //                                   bo, b, ao,
                //                                   co, ao, c);
                volumeDistribution = new FPMatrix3x3(a, co, bo,
                                                   co, b, ao,
                                                   bo, ao, c);
                ...
                FPMatrix3x3.Subtract(ref volumeDistribution, ref additionalInertia, out volumeDistribution);
        ...
        public static Fix64 ComputeMinimumRadius(IList<FPVector3> vertices, IList<int> triangleIndices, ref FPVector3 center)
        {
            ...
            for (int i = 0; i < triangleIndices.Count; i += 3)
            {
                ...
                if (lengthSquared > F64.C1em10)
                    FPVector3.Divide(ref normal, Fix64.Sqrt(lengthSquared), out normal);
                else
                    continue;
