    ...
    public class CharacterController : Updateable, IBeforeSolverUpdateable
    {
        ...
        public FPVector3 Down
        {
            ...
            set
            {
                ...
                if (lengthSquared < Toolbox.Epsilon)
                    ...
                    FPVector3.Divide(ref value, Fix64.Sqrt(lengthSquared), out value);
        ...
        public FPVector3 ViewDirection
        {
            ...
            set
            {
                ...
                {
                    FPVector3.Divide(ref value, Fix64.Sqrt(lengthSquared), out viewDirection);
                }
                else
                {
        ...
        void IBeforeSolverUpdateable.Update(Fix64 dt)
        {
            ...
            try
            {
                ...
                Fix64 verticalVelocity = FPVector3.Dot(supportData.Normal, relativeVelocity);
                ...
                if (TryToJump)
                {
                    ...
                    if (SupportFinder.HasTraction)
                    {
                        ...
                        Fix64 currentDownVelocity = FPVector3.Dot(Down, relativeVelocity);
                    ...
                    else if (SupportFinder.HasSupport)
                    {
                        ...
                        Fix64 currentNormalVelocity = FPVector3.Dot(supportData.Normal, relativeVelocity);
                        //Target velocity is JumpSpeed.
        ...
        SupportData TeleportToPosition(FPVector3 newPosition, Fix64 dt)
        {
                ...
                foreach (var contactData in pair.Contacts)
                {
                    ...
                    if (dot > minimumHeight)
                    {
                        ...
                        if (length > coreRadiusSquared)
                        {
                            ...
                            FPVector3.Multiply(ref horizontalOffset, coreRadius / Fix64.Sqrt(length), out horizontalOffset);
                        }
                        ...
                        if (length > Toolbox.Epsilon)
                        {
                            ...
                            FPVector3.Divide(ref offsetDirection, Fix64.Sqrt(length), out offsetDirection);
                        }
                        else
        ...
        public override void OnAdditionToSpace(BEPUphysicsSpace newBepUphysicsSpace)
        {
            ...
            newBepUphysicsSpace.Add(Body);
            newBepUphysicsSpace.Add(HorizontalMotionConstraint);
            newBepUphysicsSpace.Add(VerticalMotionConstraint);
            //This character controller requires the standard implementation of Space.
            newBepUphysicsSpace.BoundingBoxUpdater.Finishing += ExpandBoundingBox;
        ...
        public override void OnRemovalFromSpace(BEPUphysicsSpace oldBepUphysicsSpace)
        {
            ...
            oldBepUphysicsSpace.Remove(Body);
            oldBepUphysicsSpace.Remove(HorizontalMotionConstraint);
            oldBepUphysicsSpace.Remove(VerticalMotionConstraint);
            //This character controller requires the standard implementation of Space.
            oldBepUphysicsSpace.BoundingBoxUpdater.Finishing -= ExpandBoundingBox;
            SupportFinder.ClearSupportData();
            Body.AngularVelocity = new FPVector3();
            Body.LinearVelocity = new FPVector3();
        }
