...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class EllipseSwingLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public EllipseSwingLimit(Entity connectionA, Entity connectionB, FPVector3 twistAxis, Fix64 maximumAngleX, Fix64 maximumAngleY)
        {
        ...
        public FPVector3 LocalTwistAxisB
        {
            ...
            set
            {
                ...
                FPMatrix3x3.Transform(ref localTwistAxisB, ref connectionB.orientationMatrix, out worldTwistAxisB);
            }
        }
        ...
        public FPVector3 TwistAxisB
        {
            ...
            set
            {
                ...
                FPMatrix3x3.TransformTranspose(ref worldTwistAxisB, ref connectionB.orientationMatrix, out localTwistAxisB);
            }
        }
