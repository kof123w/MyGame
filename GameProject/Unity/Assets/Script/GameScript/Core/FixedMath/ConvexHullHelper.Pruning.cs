...
namespace FixedMath
{
    public static partial class ConvexHullHelper
    {
        ...
        public static void RemoveRedundantPoints(IList<FPVector3> points, Fix64 cellSize)
        {
        ...
        /// <param name="points">List of points to prune.</param>
        /// <param name="cellSize">Size of cells to determine redundancy.</param>
        public static void RemoveRedundantPoints(RawList<FPVector3> points, Fix64 cellSize)
        {
