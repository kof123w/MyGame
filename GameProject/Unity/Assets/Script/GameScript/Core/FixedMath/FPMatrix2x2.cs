...
namespace FixedMath
{
    ...
    public struct FPMatrix2x2
    {
        ...
        public FPMatrix2x2(Fix64 m11, Fix64 m12, Fix64 m21, Fix64 m22)
        {
            M11 = m11;
            M12 = m12;
            M21 = m21;
        ...
        {
            get { return new FPMatrix2x2(F64.C1, F64.C0, F64.C0, F64.C1); }
        }
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref FPMatrix a, ref FPMatrix2x2 b, out FPMatrix2x2 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref FPMatrix2x2 a, ref FPMatrix b, out FPMatrix2x2 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref FPMatrix a, ref FPMatrix b, out FPMatrix2x2 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
        ...
        public static void CreateScale(Fix64 scale, out FPMatrix2x2 matrix)
        {
            matrix.M11 = scale;
            matrix.M22 = scale;
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref FPMatrix2x2 a, ref FPMatrix b, out FPMatrix2x2 result)
        {
            Fix64 resultM11 = a.M11 * b.M11 + a.M12 * b.M21;
            Fix64 resultM12 = a.M11 * b.M12 + a.M12 * b.M22;
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref FPMatrix a, ref FPMatrix2x2 b, out FPMatrix2x2 result)
        {
            Fix64 resultM11 = a.M11 * b.M11 + a.M12 * b.M21;
            Fix64 resultM12 = a.M11 * b.M12 + a.M12 * b.M22;
