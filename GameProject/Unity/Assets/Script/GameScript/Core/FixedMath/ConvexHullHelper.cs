...
namespace FixedMath
{
    ...
    public static partial class ConvexHullHelper
    {
        ...
        private static void GetExtremePoints(ref FPVector3 direction, RawList<FPVector3> points, out Fix64 maximumDot, out Fix64 minimumDot, out int maximumIndex, out int minimumIndex)
        {
            maximumIndex = 0;
            minimumIndex = 0;
