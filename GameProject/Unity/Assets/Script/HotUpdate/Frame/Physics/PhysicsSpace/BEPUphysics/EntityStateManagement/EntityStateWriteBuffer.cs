...
namespace BEPUphysics.EntityStateManagement
{
    ...
    public class EntityStateWriteBuffer : ProcessingStage
    {
        ...
        internal struct EntityStateChange
        {
            internal FPQuaternion OrientationFpQuaternion;
        ...
        ///</summary>
        ///<param name="entity">Entity to target.</param>
        ///<param name="newOrientationFpQuaternion">New orientation of the entity.</param>
        public void EnqueueOrientation(Entity entity, ref FPQuaternion newOrientationFpQuaternion)
        {
            stateChanges.Enqueue(new EntityStateChange { target = entity, OrientationFpQuaternion = newOrientationFpQuaternion, targetField = TargetField.Orientation });
        }
        ///<summary>
            ...
            while (stateChanges.TryDequeueFirst(out item))
            {
                ...
                switch (item.targetField)
                {
                    ...
                    case TargetField.Orientation:
                        target.Orientation = item.OrientationFpQuaternion;
                        break;
