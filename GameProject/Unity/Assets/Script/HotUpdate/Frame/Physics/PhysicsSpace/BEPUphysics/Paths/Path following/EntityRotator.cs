...
namespace BEPUphysics.Paths.PathFollowing
{
    ...
    public class EntityRotator : Updateable, IDuringForcesUpdateable
    {
        ...
        public static FPVector3 GetAngularVelocity(FPQuaternion start, FPQuaternion end, Fix64 dt)
        {
        ...
        {
            newBepUphysicsSpace.Add(AngularMotor);
        }
        ...
        {
            oldBepUphysicsSpace.Remove(AngularMotor);
        }
