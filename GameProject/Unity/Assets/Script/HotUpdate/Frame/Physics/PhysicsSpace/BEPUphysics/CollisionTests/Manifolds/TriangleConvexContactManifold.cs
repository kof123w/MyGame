...
namespace BEPUphysics.CollisionTests.Manifolds
{
    ...
    public class TriangleConvexContactManifold : ContactManifold
    {
        ...
        public override void Update(Fix64 dt)
        {
            ...
            FPMatrix3x3.CreateFromQuaternion(ref triangle.worldTransform.Orientation, out orientation);
            FPMatrix3x3.Transform(ref triangle.Shape.vA, ref orientation, out localTriangleShape.vA);
            FPMatrix3x3.Transform(ref triangle.Shape.vB, ref orientation, out localTriangleShape.vB);
            FPMatrix3x3.Transform(ref triangle.Shape.vC, ref orientation, out localTriangleShape.vC);
            ...
            FPMatrix3x3.CreateFromQuaternion(ref convex.worldTransform.Orientation, out orientation);
            FPMatrix3x3.TransformTranspose(ref localTriangleShape.vA, ref orientation, out localTriangleShape.vA);
            FPMatrix3x3.TransformTranspose(ref localTriangleShape.vB, ref orientation, out localTriangleShape.vB);
            FPMatrix3x3.TransformTranspose(ref localTriangleShape.vC, ref orientation, out localTriangleShape.vC);
