...
namespace BEPUphysics.Vehicle
{
    ...
    public abstract class WheelShape : ICollisionRulesOwner
    {
        ...
        protected internal FPMatrix localGraphicTransform;
        ...
        internal FPMatrix steeringTransform;
        protected internal Wheel wheel;

        protected internal FPMatrix worldTransform;
        ...
        /// </summary>
        public FPMatrix LocalGraphicTransform
        {
        ...
        protected internal abstract bool FindSupport(out FPVector3 location, out FPVector3 normal, out Fix64 suspensionLength, out Collidable supportCollidable, out Entity entity, out Material material);
