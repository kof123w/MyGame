    ...
    public class LinearAxisMotor : Motor, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public FPVector3 Axis
        {
            ...
            set
            {
                ...
                FPMatrix3x3.TransformTranspose(ref worldAxis, ref connectionA.orientationMatrix, out localAxis);
            }
        }
        ...
        public FPVector3 LocalAxis
        {
            ...
            set
            {
                ...
                FPMatrix3x3.Transform(ref localAxis, ref connectionA.orientationMatrix, out worldAxis);
            }
        }
        ...
        public FPVector3 OffsetA
        {
            ...
            set
            {
                worldOffsetA = value;
                worldAnchorA = connectionA.position + worldOffsetA;
                FPMatrix3x3.TransformTranspose(ref worldOffsetA, ref connectionA.orientationMatrix, out localAnchorA); //Looks weird, but localAnchorA is "localOffsetA."
        ...
        public FPVector3 OffsetB
        {
            ...
            set
            {
                worldOffsetB = value;
                worldAnchorB = connectionB.position + worldOffsetB;
                FPMatrix3x3.TransformTranspose(ref worldOffsetB, ref connectionB.orientationMatrix, out localAnchorB);//Looks weird, but localAnchorB is "localOffsetB."
            }
        }
        ...
        public override void Update(Fix64 dt)
        {
            ...
            if (connectionA.isDynamic)
            {
                FPMatrix3x3.Transform(ref jAngularA, ref connectionA.inertiaTensorInverse, out intermediate);
            ...
            if (connectionB.isDynamic)
            {
                FPMatrix3x3.Transform(ref jAngularB, ref connectionB.inertiaTensorInverse, out intermediate);
