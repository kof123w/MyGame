...
namespace BEPUphysics.Paths
{
    ...
    public class VariableLinearSpeedCurve : VariableSpeedCurve<FPVector3>
    {
        ...
        public VariableLinearSpeedCurve(Path<Fix64> speedCurve, Curve<FPVector3> curve)
        ...
        public VariableLinearSpeedCurve(Path<Fix64> speedCurve, Curve<FPVector3> curve, int sampleCount)
