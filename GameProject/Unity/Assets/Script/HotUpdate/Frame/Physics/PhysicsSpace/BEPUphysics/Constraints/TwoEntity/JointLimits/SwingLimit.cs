...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class SwingLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public SwingLimit(Entity connectionA, Entity connectionB, FPVector3 axisA, FPVector3 axisB, Fix64 maximumAngle)
        {
        ...
        public override void Update(Fix64 dt)
        {
            ...
            if (connectionA.isDynamic)
            {
                FPMatrix3x3.Transform(ref hingeAxis, ref connectionA.inertiaTensorInverse, out transformedAxis);
            ...
            if (connectionB.isDynamic)
            {
                FPMatrix3x3.Transform(ref hingeAxis, ref connectionB.inertiaTensorInverse, out transformedAxis);
