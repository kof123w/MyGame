...
namespace FixedMath
{
    ...
    public static class MathChecker
    {
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this FPMatrix2x2 m)
        {
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this FPMatrix3x2 m)
        {
            if (IsInvalid(m.M11) || IsInvalid(m.M12) ||
                IsInvalid(m.M21) || IsInvalid(m.M22) ||
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this FPMatrix2x3 m)
        {
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this FPMatrix3x3 m)
        {
            m.Right.Validate();
            m.Up.Validate();
            m.Backward.Validate();
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this FPMatrix m)
        {
            m.Right.Validate();
            m.Up.Validate();
            m.Backward.Validate();
